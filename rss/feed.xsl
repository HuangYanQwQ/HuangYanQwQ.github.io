...
<xsl:stylesheet version="3.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
                        ...
                        <div class="profile-card">
                            <div class="avatar-wrapper">
                                <div class="avatar-container">
                                    <img src="/img/avatar.webp" alt="うそちゃん❤" class="avatar" />
                            ...
                            <div class="profile-info">
                                <h1 class="site-title">うそちゃんの博客</h1>
                                <p class="site-subtitle">null</p>
                                <p class="site-bio">null</p>

                                <div class="social-links">
                                                    <a href="https://github.com/HuangYanQwQ" target="_blank" class="social-btn github" title="Github">
                                                        <i class="ri-github-fill"></i>
                                                    </a>
                                                    <a href="mailto:HuangYanQwQ@outlook.com" target="_blank" class="social-btn email" title="Email">
    ...
    阅读全文 <i class="ri-arrow-right-s-line"></i>
                    ...
                    <footer class="page-footer">
                        <p>Designed with <i class="ri-heart-3-fill heart-beat"></i> by HuangYanQwQ</p>
                        <p class="copyright">
